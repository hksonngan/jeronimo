...
The method allows shape magnification and exaggeration using the laplacian
smoothing operator in the reverse direction, generating a parameterized
family of shapes from a set of vertices which represent a coarse sketch
of the desired model. Our approach can be mixed with traditional or
uniform subdivision surfaces methods, is iterative and converges towards
a continuous and smooth version of the original model. 

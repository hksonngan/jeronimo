...
applications in sculpting, subdivision and modeling methods.
...
we use three models with 12K, 40K and 164K this models were sculpted
with curvature enhance brush in eache step the brush sphere contain
a variable number of vertices for processing. The processing time
for 800 vertices in the camel paw (40k model) only take 0.1 seconds,

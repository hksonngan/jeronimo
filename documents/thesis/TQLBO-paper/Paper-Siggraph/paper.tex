...
the larger enhancements on the model features. In the bottom row of
...
Our method is invariant of rotation, this since depends solely the
normal field of the mesh, wish is invariant under global rotations. 
...
we show the performance of curvature enhancement brush, in this experiment

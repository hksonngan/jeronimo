...
the quality, predictability and flexibility of our results.
\end{abstract}
...
named \textsl{Drag Dot}  which allows you to preview the change that
occurs in the model until you release the mouse button or tablet,
also enable moves the mouse over the model to fit exactly where you
want to perform the enhancement of the curvature.
